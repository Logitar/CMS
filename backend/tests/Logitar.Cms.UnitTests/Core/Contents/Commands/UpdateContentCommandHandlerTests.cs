...
public class UpdateContentCommandHandlerTests
{
  ...
  public async Task Given_ContentNotFound_When_Handle_Then_NullReturned()
  {
    ...
    UpdateContentLocaleCommand command = new(Guid.NewGuid(), LanguageId: null, payload);
  ...
  public async Task Given_ContentLocaleNotFound_When_Handle_Then_NullReturned()
  {
    ...
    UpdateContentLocalePayload payload = new();
    UpdateContentLocaleCommand command = new(content.Id.ToGuid(), language.Id.ToGuid(), payload);
  ...
  public async Task Given_LanguageNotFound_When_Handle_Then_LanguageNotFoundException()
  {
    ...
    UpdateContentLocalePayload payload = new();
    UpdateContentLocaleCommand command = new(content.Id.ToGuid(), Guid.NewGuid(), payload);
