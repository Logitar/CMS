...
public class ReplaceFieldTypeCommandTests : IntegrationTests
{
  private readonly IFieldTypeRepository _fieldTypeRepository;

  private readonly FieldTypeAggregate _fieldType;

  public ReplaceFieldTypeCommandTests() : base()
  {
  ...
  public async Task It_should_replace_an_existing_field_type()
  {
    ...
    ReplaceFieldTypePayload payload = new(_fieldType.UniqueName.Value)
    {
  ...
  {
    ReplaceFieldTypePayload payload = new("SubTitle");
    ReplaceFieldTypeCommand command = new(Id: Guid.NewGuid(), payload, Version: null);
  ...
  public async Task It_should_throw_UniqueNameAlreadyUsedException_when_the_unique_name_is_already_used()
  {
    ...
    ReplaceFieldTypeCommand command = new(_fieldType.Id.ToGuid(), payload, Version: null);
