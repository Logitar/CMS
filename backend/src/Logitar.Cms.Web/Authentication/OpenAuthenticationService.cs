...
internal class OpenAuthenticationService : IOpenAuthenticationService
{
  ...
  private ConfigurationModel Configuration => _cacheService.GetConfiguration();
  ...
  public async Task<SessionModel> ValidateTokenAsync(string token, CancellationToken cancellationToken)
  {
