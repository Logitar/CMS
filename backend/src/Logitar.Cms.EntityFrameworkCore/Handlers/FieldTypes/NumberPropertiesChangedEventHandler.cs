...
internal class NumberPropertiesChangedEventHandler : INotificationHandler<NumberPropertiesChangedEvent>
{
  private readonly CmsContext _context;

  public NumberPropertiesChangedEventHandler(CmsContext context)
  {
    _context = context;
  }

  public async Task Handle(NumberPropertiesChangedEvent @event, CancellationToken cancellationToken)
  {
