...
internal class TextPropertiesChangedEventHandler : INotificationHandler<TextPropertiesChangedEvent>
{
  private readonly CmsContext _context;

  public TextPropertiesChangedEventHandler(CmsContext context)
  {
    _context = context;
  }

  public async Task Handle(TextPropertiesChangedEvent @event, CancellationToken cancellationToken)
  {
