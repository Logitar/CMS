...
internal class BooleanPropertiesChangedEventHandler : INotificationHandler<BooleanPropertiesChangedEvent>
{
  private readonly CmsContext _context;

  public BooleanPropertiesChangedEventHandler(CmsContext context)
  {
    _context = context;
  }

  public async Task Handle(BooleanPropertiesChangedEvent @event, CancellationToken cancellationToken)
  {
