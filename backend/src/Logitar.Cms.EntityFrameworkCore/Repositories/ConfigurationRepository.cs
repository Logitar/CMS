...
internal class ConfigurationRepository : EventSourcing.EntityFrameworkCore.Relational.AggregateRepository, IConfigurationRepository
{
  ...
  public ConfigurationRepository(ICacheService cacheService, IConfigurationQuerier configurationQuerier, IEventBus eventBus, EventContext eventContext, IEventSerializer eventSerializer)
  ...
  {
    return await LoadAsync<ConfigurationAggregate>(new ConfigurationId().AggregateId, cancellationToken);
  }
