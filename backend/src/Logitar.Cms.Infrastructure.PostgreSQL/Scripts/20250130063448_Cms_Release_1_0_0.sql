...
CREATE TABLE "Cms"."Contents" (
    ...
    CONSTRAINT "FK_Contents_ContentTypes_ContentTypeId" FOREIGN KEY ("ContentTypeId") REFERENCES "Cms"."ContentTypes" ("ContentTypeId") ON DELETE RESTRICT
);
...
CREATE TABLE "Cms"."FieldDefinitions" (
    ...
    CONSTRAINT "FK_FieldDefinitions_FieldTypes_FieldTypeId" FOREIGN KEY ("FieldTypeId") REFERENCES "Cms"."FieldTypes" ("FieldTypeId") ON DELETE RESTRICT
);
...
CREATE TABLE "Cms"."ContentLocales" (
    ...
    CONSTRAINT "FK_ContentLocales_ContentTypes_ContentTypeId" FOREIGN KEY ("ContentTypeId") REFERENCES "Cms"."ContentTypes" ("ContentTypeId") ON DELETE RESTRICT,
    ...
    CONSTRAINT "FK_ContentLocales_Languages_LanguageId" FOREIGN KEY ("LanguageId") REFERENCES "Cms"."Languages" ("LanguageId") ON DELETE RESTRICT
);
...
CREATE TABLE "Cms"."PublishedContents" (
    ...
    CONSTRAINT "FK_PublishedContents_ContentTypes_ContentTypeId" FOREIGN KEY ("ContentTypeId") REFERENCES "Cms"."ContentTypes" ("ContentTypeId") ON DELETE RESTRICT,
    CONSTRAINT "FK_PublishedContents_Contents_ContentId" FOREIGN KEY ("ContentId") REFERENCES "Cms"."Contents" ("ContentId") ON DELETE RESTRICT,
    CONSTRAINT "FK_PublishedContents_Languages_LanguageId" FOREIGN KEY ("LanguageId") REFERENCES "Cms"."Languages" ("LanguageId") ON DELETE RESTRICT
);
...
CREATE UNIQUE INDEX "IX_ContentLocales_ContentId_LanguageId" ON "Cms"."ContentLocales" ("ContentId", "LanguageId");

CREATE UNIQUE INDEX "IX_ContentLocales_ContentTypeId_LanguageId_UniqueNameNormalized" ON "Cms"."ContentLocales" ("ContentTypeId", "LanguageId", "UniqueNameNormalized");
...
CREATE UNIQUE INDEX "IX_UniqueIndex_FieldDefinitionId_LanguageId_Status_ValueNormal~" ON "Cms"."UniqueIndex" ("FieldDefinitionId", "LanguageId", "Status", "ValueNormalized");
...
VALUES ('20250130063448_Cms_Release_1_0_0', '9.0.0');
