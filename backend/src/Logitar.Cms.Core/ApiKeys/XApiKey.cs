...
internal record XApiKey
{
  ...
  private const string Prefix = "AK"; // ISSUE: https://github.com/Logitar/CMS/issues/12
  ...
  public static string Encode(ApiKeyAggregate apiKey, string secret) => Encode(apiKey.Id, secret);
