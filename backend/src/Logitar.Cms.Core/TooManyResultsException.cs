...
public class TooManyResultsException : BadRequestException
{
  ...
  public override Error Error => new Error(this.GetErrorCode(), ErrorMessage)
    .Add(new ErrorData(nameof(ExpectedCount), ExpectedCount.ToString()))
    .Add(new ErrorData(nameof(ActualCount), ActualCount.ToString()));
