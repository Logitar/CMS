...
internal class CreateContentTypeCommandHandler : IRequestHandler<CreateContentTypeCommand, ContentsType>
{
  ...
  public async Task<ContentsType> Handle(CreateContentTypeCommand command, CancellationToken cancellationToken)
  {
